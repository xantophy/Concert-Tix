...
<html lang="en">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 mt-4 mt-lg-0">
          <div class="card summary-card" id="orderSummary">
            ...
            <a href="../../user/payment/index.html" class="btn btn-beli" id="beliBtn" disabled> <i class="bi bi-credit-card me-2"></i> Proceed to Payment </a>
    ...
    <script>
      ...
      let cartItems = [
        {
          ...
          date: "Wed, Nov 15, 2023 - Gelora Bung Karno Stadium",
          type: "Regular Ticket",
          price: 1500000,
          quantity: 1,
          image: "https://i.pinimg.com/736x/bc/af/9b/bcaf9bfe50f2e039edbfcd7c191df4b6.jpg",
        },
        {
          id: 2,
          title: "Blackpink: Born Pink World Tour",
          date: "Sat, Mar 11, 2024 - Indonesia Convention Exhibition",
          type: "VIP Ticket",
          price: 2500000,
          quantity: 2,
          image: "https://i.pinimg.com/736x/04/a6/b0/04a6b06634ce8b9c7a9cfabcfc395dc9.jpg",
        },
        {
          id: 3,
          title: "Ed Sheeran: Mathematics Tour",
          date: "Fri, May 5, 2024 - Jakarta International Stadium",
          type: "Gold Ticket",
          price: 2500000,
          quantity: 1,
          image: "https://i.pinimg.com/736x/1e/ff/0f/1eff0f05d84c1d09f97cf11f962f0fc1.jpg",
        },
      ];
      ...
      function renderCartItems(items) {
        ...
        items.forEach((item) => {
          ...
          html += `
    <div class="card mb-3 cart-item-card" data-cart-item-id="${item.CartItemID}">
      <div class="card-body">
        <div class="d-flex">
  ...
  <div class="d-flex justify-content-between mt-4">
    <button class="btn btn-outline-danger" id="clearCartBtn">
      ...
      function deleteCartItem(cartItemId, cardElement) {
        fetch("../../auth/update_cart.php", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          ...
          .then((result) => {
            if (result.success) {
              ...
              updateCartTotal();
              updateCartCount();
              // Jika tidak ada item lagi, tampilkan cart kosong
