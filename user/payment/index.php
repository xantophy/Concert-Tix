    ...
    <div class="row g-4">
      <div class="col-lg-8">
        ...
        <div class="payment-card">
          ...
          <!-- E-Wallet Options (awal disembunyikan) -->
          <div id="ewallet-options" class="payment-options-container">
            <div class="payment-options-scroll">
              <div class="payment-option" onclick="selectPaymentMethod('Dana')">
                <img src="https://i.pinimg.com/736x/cb/aa/03/cbaa0388892e0a154353c2a1cb8b3fee.jpg" alt="Dana" width="50" height="50">
                <div>Dana</div>
              </div>
              <div class="payment-option" onclick="selectPaymentMethod('OVO')">
                <img src="https://i.pinimg.com/736x/61/c9/8a/61c98a1dffc2e04424d592564cef941f.jpg" alt="OVO" width="50" height="50">
                <div>OVO</div>
              </div>
              <div class="payment-option" onclick="selectPaymentMethod('GoPay')">
                <img src="https://i.pinimg.com/736x/fe/ce/b2/feceb2ca508603b06c2f7ba18a5d018d.jpg" alt="GoPay" width="50" height="50">
                <div>GoPay</div>
              </div>
          ...
          <!-- QRIS Options (awal disembunyikan) -->
...
function processPayment() {
  ...
  // Convert to uppercase to match confirmation page
  const methodMap = {
    'bca': 'BCA',
    'bri': 'BRI',
    'mandiri': 'Mandiri',
  ...
  const methodName = methodMap[selectedPaymentMethod.toLowerCase()] || selectedPaymentMethod.toUpperCase();
  window.location.href = `payment-confirmation fix.html?method=${methodName}`;
}
